...
const targetUrl = 'https://jb-studio-site-mk9zqo5h7-micarlojean2-2185s-projects.vercel.app/asistente?id=spa';

console.log('=== PRUEBA DE PEDIDO DE CAMBIO EN PASO CONFIRMATION (PRODUCCIÓN ACTUAL) ===');
...
try {
  ...
  console.log('\nRespuesta exacta de la IA en Producción Actual (Caso 1):\n"""\n' + resp1 + '\n"""\n');
  ...
  console.log('\nRespuesta exacta de la IA en Producción Actual (Caso 2):\n"""\n' + resp2 + '\n"""\n');
